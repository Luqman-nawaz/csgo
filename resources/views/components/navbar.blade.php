            ...
            <div class="width-85 mx-auto flex justify-between items-center">
                <div class="leftmenu-container w-5/12 flex items-center">
                    ...
                    <div class="dropdown-box">
                        <a href="#" class="boost-link">Boost</a>
                        <div class="pt-3">
                            <div class="boost-dropdown">
                                <a href="/csboost">CS2 Boost</a>
                                <a href="/premier">CS2 Premiere Boost</a>
                                <a href="/esea">ESEA Boost</a>
                                <a href="/esportal">ESPORTAL Boost</a>
                                <a href="/faceit">FACEIT Boost</a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="logo-container w-3/12 flex justify-between items-center">
                    <img src="/assets/logo.svg" class="m-auto" alt="" style="cursor: pointer;" alt="" onclick="window.location.href='/'";>
                </div>
