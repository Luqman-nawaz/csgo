...
@section('content')
    ...
    <div class="csgo-howtobuy-conatianer csgo-howtobuy-conatianer-esportal">
            ...
            <div class="shape-try">
                <div class="csgo-boost-howtobuy-content">
                    <form action="/checkout" method="post">
                            ...
                            <div class="csgo-boost-howtobuy-para">
                                ...
                                <div class="csgo-boost-rank-title-conatiner">
                                    <div class="csgo-boost-rank-title-box">
                                        <h3>Current Esportal Level</h3>

                                        <div
                                            class="csgo-boost-rank-select-container csgo-boost-faceit-rank-select-container">
                                            <img src="./assets/img/image 5.png" alt="" class="rank-img rank-img-large">
                                            ...
                                            <div class="addLocationProduct-boost-rank-dropdown">
                                                ...
                                                <div class="addLocationProduct-boost-rank-dropdown-menu">
                                                    <p class="addLocationProduct-boost-rank-option" href="#">Rank Silver</p>
                                                    <p class="addLocationProduct-boost-rank-option" href="#">Rank Gold 1</p>
                                                    <p class="addLocationProduct-boost-rank-option" href="#">Rank Gold 2</p>
                                                    <p class="addLocationProduct-boost-rank-option" href="#">Rank Veteran 1</p>
                                                    <p class="addLocationProduct-boost-rank-option" href="#">Rank Veteran 2</p>
                                                    <p class="addLocationProduct-boost-rank-option" href="#">Rank Master 1</p>
                                                    <p class="addLocationProduct-boost-rank-option" href="#">Rank Master 2</p>
                                                    <p class="addLocationProduct-boost-rank-option" href="#">Rank Elite 1</p>
                                                    <p class="addLocationProduct-boost-rank-option" href="#">Rank Elite 2</p>
                                                    <p class="addLocationProduct-boost-rank-option" href="#">Rank Pro 1</p>
                                                    <p class="addLocationProduct-boost-rank-option" href="#">Rank Pro 2</p>
                                                </div>
                                            </div>
                                    ...
                                    <!-- </div> -->
                                    <div class="csgo-boost-rank-title-box">
                                        <h3>Desired Esportal Rank</h3>
                                        <div
                                            class="csgo-boost-rank-select-container csgo-boost-faceit-rank-select-container">
                                            <img src="./assets/img/image 5 (1).png" alt=""
                        ...
                        <input type="text" name="boost_id" value="3" style="display: none;"/>
                        <input type="text" name="boost_type" value="Esportal Rank Boost" style="display: none;"/>
                    </form>
                    ...
                    <form action="/checkout" method="post">
                        ...
                        <input type="text" name="boost_id" value="3" style="display: none;"/>
                        <input type="text" name="boost_type" value="Esportal Win Boost" style="display: none;"/>
                    </form>
